...
<center>
  ...
  <h4>Klik detail untuk melihat detail piutang, klik bayar untuk pembayaran cicilan piutang</h4><br>
        ...
        <div class="col-sm-6">
          <form class="navbar-form navbar-right" role="search" action="piutang.php" method="GET">
            <div class="form-group">
              <input type="text" class="form-control" name="cari" action="piutang.php" method="GET" placeholder="Nama pelanggan . . .">
            </div>
          ...
          ";
            ...
            <tr>
              ...
              <td>
                ...
                <a href='bayar_piutang.php?id=$data[kodepenjualan]' class='btn btn-success''><svg-icon>Bayar</a>
              </td>
            </tr>";
              }
        echo "</table>";
