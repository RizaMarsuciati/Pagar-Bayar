...
<center>
  <div >
    ...
    <h4>Informasi detail penjualan</h4><br>
    ...
    <div class="table-responsive">
          <table class="table table-striped" style="margin: 0 auto;">
            ...
            ";
                ...
                $totalbayar=0;
                $hasilakhir=0;
                $tampil=mysqli_query($connect, "SELECT  c.kodepenjualan, a.kodedtpenjualan, b.kodebarang, b.namabarang, a.jumlah,c.persenbunga, a.hargajual, a.total FROM detailpenjualan a JOIN barang b ON a.kodebarang=b.kodebarang LEFT JOIN penjualan c ON a.kodepenjualan=c.kodepenjualan WHERE a.kodepenjualan='$_GET[id]'"); 
          ...
          echo "</table>";
            ...
            <center>
              <a href="penjualan.php"><input type="button" value="Kembali" class="btn btn-secondary">
              <?php echo"
